...
- [ ] Botao "Entrar com Google" visivel no LoginScreen
- [ ] Fluxo PKCE via `expo-auth-session` (sem redirects nativos — usar Proxy Expo)
- [ ] Ao sucesso, chama `POST /api/v1/auth/google` com o code recebido
- [ ] Erros exibidos com toast/feedback adequado
