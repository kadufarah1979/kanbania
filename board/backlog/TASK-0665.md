...
- [ ] authStore.setUser() chamado com dados retornados pelo backend
- [ ] access_token e refresh_token salvos no MMKV
- [ ] Navegacao automatica para UserNavigator apos sucesso
- [ ] Em caso de erro (403, 500), exibir mensagem clara
