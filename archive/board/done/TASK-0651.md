...
acted_by:
  ...
  - agent: "claude-code"
    action: claimed
    date: "2026-02-28T04:32:05-03:00"
  - agent: "claude-code"
    action: done
    date: "2026-02-28T04:32:05-03:00"
    note: "Implementado: build inclui esbuild server.ts->dist/server.js. create-kanbania atualizado."
---
...
separada), gerando um `server.js` compilado — eliminando a dependencia
do `tsx` em producao.
